...
export type GetAllPeopleQuery = { __typename: 'Root', allPeople: { __typename: 'PeopleConnection', totalCount: number, people: Array<{ __typename: 'Person', name: string, id: string }> , pageInfo: { __typename: 'PageInfo', endCursor: string} }};

export type GetCurrentHeroQueryVariables = Exact<{
  id: Scalars['ID'];
}>;


export type GetCurrentHeroQuery = { __typename?: 'Root', person?: { __typename?: 'Person', name?: string | null, birthYear?: string | null, gender?: string | null, species?: { __typename?: 'Species', name?: string | null } | null, homeworld?: { __typename?: 'Planet', name?: string | null } | null } | null };
...
export const GetCurrentHeroDocument = gql`
...
/**
 * __useGetCurrentHeroQuery__
 *
 * To run a query within a React component, call `useGetCurrentHeroQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetCurrentHeroQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetCurrentHeroQuery({
 *   variables: {
 *      id: // value for 'id'
 *   },
 * });
 */
export function useGetCurrentHeroQuery(baseOptions: Apollo.QueryHookOptions<GetCurrentHeroQuery, GetCurrentHeroQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetCurrentHeroQuery, GetCurrentHeroQueryVariables>(GetCurrentHeroDocument, options);
      }
export function useGetCurrentHeroLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetCurrentHeroQuery, GetCurrentHeroQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetCurrentHeroQuery, GetCurrentHeroQueryVariables>(GetCurrentHeroDocument, options);
        }
export type GetCurrentHeroQueryHookResult = ReturnType<typeof useGetCurrentHeroQuery>;
export type GetCurrentHeroLazyQueryHookResult = ReturnType<typeof useGetCurrentHeroLazyQuery>;
export type GetCurrentHeroQueryResult = Apollo.QueryResult<GetCurrentHeroQuery, GetCurrentHeroQueryVariables>;